...
const PAISES = [
    ...
    { nombre: "UY", url: "https://uy.integra-metrics.com/api/v2/estado-soft?data=%7B%7D", token: "759361d51187fe9dbd526e0219a098b92d05249b29ee69778fb11e9e70cf7bdacec61e4e5b195d32948c5ba1b35dbb239a7286a69a687cbfe055d380a9209013", indice: 3 }
];
...
async function consultarTodasLasAPIs() {
    ...
    for (const pais of PAISES) {
        try {
            ...
            const subarray = arraysValidos[pais.indice] || [];

            mensajes.push(`*${pais.nombre}* (Índice ${pais.indice}):\n${subarray.join("\n")}`);
